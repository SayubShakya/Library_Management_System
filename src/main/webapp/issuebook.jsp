	...
	<div class="form-container">
		<form action="IssueBook" method="get">
			...
			<label for="bid">Book ID:</label> <input type="text" id="bid"
				name="bid" placeholder="Enter your book ID"> <label
				for="sid">Student ID:</label> <input type="text" id="sid" name="sid"
				placeholder="Enter your student ID"> <label for="issuedate">Issue
				Date:</label> <input type="date" id="issuedate" name="issuedate"> <label
				for="duedate">Due Date:</label> <input type="date" id="duedate"
				name="duedate"> <input type="submit" value="Submit">
