...
<body>
	<nav>
		...
		<ul class="menu">
			<li class="nav__item"><a href="StudentDash.jsp">Home</a></li>
			<li class="nav__item"><a href="ViewProfile.jsp">View Profile</a></li>
			<li class="nav__item"><a href="EditProfile.jsp">Edit Profile</a></li>
			<li class="nav__item"><a href="ChangePassword.jsp">Change
					Password</a></li>
	...
	<main>
		<div class="center">
			...
			<div class="row justify-content-center">
				...
				<br> <a href="StudentDash.jsp" class="btn btn-home">Go to
					Dashboard</a>
			</div>
		</div>
	</main>
